...
const TOKEN_NAME = "BLOOD";
const TOKEN_SYMBOL = "BLOOD";
const TOKEN_DESCRIPTION = "Auraland's Only Currency";
const TOKEN_IMAGE_NAME = "blood.png"; // Replace unicorn.png with your image name
const TOKEN_IMAGE_PATH = `tokens/blood/assets/${TOKEN_IMAGE_NAME}`;

async function createBloodToken(
...
async function main() {
  ...
  await createBloodToken(connection, payer);
